    ...
    <div>
      ...
      <div className="absolute">
        <img
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmARU_QFzydNJC5OD5Gv23uA1O7V00r-uumQ&s"
          alt="banner"
        />
      </div>
      <form
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <button
            type="submit"
            className="bg-blue-700 mt-6 p-3 text-white rounded-sm font-medium"
          >{`${
            isLoading ? "loading..." : isLogin ? "Login" : "Signup"
          }`}</button>
          <p className="text-white mt-2">
            {isLogin ? "Does't have an account ?" : "Already have an account ?"}
            <span
